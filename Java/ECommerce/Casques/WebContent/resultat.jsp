<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <% 
	...
	lesProduits=(ArrayList<Produit>)request.getAttribute("produitCherche");
	
	request.getSession().setAttribute("categorie", "resultat.jsp");
   ...
   <!-- Fin Secteur Menu -->
	...
	<div class="container" id="categorie" name="categorie">
		<br>
			<div class="row">
				<br>
				<h1 class="centered">Resultats des recherches</h1>
				<hr>
				<br>
				<br>
			</div><!-- /row -->
						      ...
						      <div class="modal-content">
						        <div class="modal-header">
						          ...
						          <form action="servletGererPanier" method="post">
									...
									<input class="text-right" class="qte" type="text" class="col-md-3" name="quantite"/>
